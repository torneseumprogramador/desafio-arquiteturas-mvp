...
describe('API Integration Tests', () => {
  ...
  describe('GET /api/produtos/:id', () => {
    it('deve retornar produto por ID', async () => {
      const produto = { id: 1, nome: 'Notebook', preco: 2500.00, descricao: 'Notebook Dell', quantidade: 10 };
  ...
  describe('PUT /api/produtos/:id', () => {
    it('deve atualizar produto com sucesso', async () => {
      ...
      const produtoAtualizado = { id: 1, ...dadosAtualizados, descricao: 'Notebook Dell', quantidade: 10 };
