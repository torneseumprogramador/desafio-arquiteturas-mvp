...
describe("ListarProdutosUseCase", () => {
  ...
  describe("Executar", () => {
    ...
    it("deve retornar produtos com dados completos", async () => {
      const produtos = [
        new Produto(1, "Notebook", 2500.0, "Notebook Dell Inspiron", 10),
        new Produto(2, "Mouse", 50.0, "Mouse sem fio Logitech", 20),
        new Produto(3, "Teclado", 150.0, "Teclado mecânico", 15),
      ];
      ...
      expect(resultado[0].preco).toBe(2500.0);
