...
describe('Produto Entity', () => {
  ...
  beforeEach(() => {
    produto = new Produto(1, 'Notebook', 2500.00, 'Notebook Dell Inspiron', 10);
  });
  ...
  describe('Constructor', () => {
    it('deve criar um produto com todos os atributos', () => {
      ...
      expect(produto.preco).toBe(2500.00);
    ...
    it('deve criar um produto sem ID (novo produto)', () => {
      const novoProduto = new Produto(null, 'Mouse', 50.00, 'Mouse sem fio', 5);
  ...
  describe('Métodos', () => {
    ...
    it('deve calcular valor total do estoque', () => {
      ...
      expect(valorTotal).toBe(25000.00); // 2500 * 10
    });
